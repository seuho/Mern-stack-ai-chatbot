...
const Chat = () => {
  ...
  useLayoutEffect(() => {
    if (auth?.isLoggedIn && auth.user && !hasFetchedChats.current) {
  ...
  return (
    <Box sx={{ display: "flex", flex: 1, width: "100%", height: "100%", mt: 3, gap: 3 }}>
      <Box sx={{ display: { md: "flex", xs: "none", sm: "none" }, flex: 0.2, flexDirection: "column" }}>
        <Box sx={{ display: "flex", width: "100%", height: "100%", bgcolor: "rgb(17,29,39)", borderRadius: 5, flexDirection: "column", mx: 3, paddingTop: "10vh" }}>
      ...
      <Box sx={{ display: "flex", flex: { md: 0.8, xs: 1, sm: 1 }, flexDirection: "column", px: 3 }}>
        ...
        <Box sx={{ width: "100%", height: "60vh", background: "black", borderRadius: 3, mx: "auto", display: "flex", flexDirection: "column", overflow: "scroll", overflowX: "hidden", overflowY: "auto", scrollBehavior: "smooth" }}>
